  ...
  <div>
    ...
    <div class="alldata">
      ...
      >
        ...
        <el-table-column prop="KGSJ" label="开工时间"></el-table-column>
        <el-table-column prop="BZ" label="备注"></el-table-column>
        <el-table-column prop="address" label="操作" append>
          <template slot-scope="scope">
            <span size="mini" @click="startCheck(scope.row)">完工</span>
            <span size="mini" @click="startDelete(scope.row)">删除</span>
            <span size="mini" @click="startRemark(scope.row)">备注</span>
          </template>
        </el-table-column>
      </el-table>
    ...
    <div class="zheZhao" v-if="dialogVisible">
      <div class="startBox" v-if="flag">
        <h4>完工</h4>
        <div class="touble-start">
        ...
        <div class="touble-btn">
          ...
          <el-button @click="save" class="buttons">保存</el-button>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    save() {
      this.$axios
        .post(
          "api/info/web/zrenwuWg",
          { renwu_id: this.wanId, wgsj: this.value3 },
          {
            headers: {
              "X-Requested-With": "XMLHttpRequest",
              "Content-Type": "application/x-www-form-urlencoded"
